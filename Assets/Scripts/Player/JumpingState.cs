...
public class JumpingState : State
{
    ...
    public JumpingState(PlayerController _character, StateMachine _stateMachine) : base(_character, _stateMachine)
    {
    ...
    void Jump()
    {
        // v = sqrt(2 * h * |g|) — the velocity that reaches exactly jumpHeight.
